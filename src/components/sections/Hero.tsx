        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          <motion.div className="lg:col-span-6" {...container}>
            ...
            <motion.h1 {...item} className="mt-5 font-heading font-extrabold text-espresso text-4xl sm:text-5xl lg:text-[3.5rem] xl:text-6xl leading-[1.05] tracking-tight">
              {COPY.hero.h1Lead}{" "}
              <span className="relative z-10 bg-gradient-to-r from-clay via-clay-light to-gold bg-clip-text text-transparent">{COPY.hero.h1Highlight}</span>.
            </motion.h1>
            ...
            <motion.div {...item} className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-mocha">
              <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-clay" />Same-day certificates</span>
              <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-clay" />DOT compliance support</span>
              <span className="inline-flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-clay" />Licensed all 50 states</span>
              <span className="inline-flex items-center gap-1.5"><Star className="h-4 w-4 text-gold fill-gold" />20+ years in trucking</span>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-3 md:-right-6 bg-clay text-white rounded-2xl shadow-warm-lg px-4 py-3"
              >
