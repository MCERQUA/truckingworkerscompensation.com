      ...
      <nav className="container-wide flex items-center justify-between h-18 py-3">
        <Link href="/" className="flex items-center gap-2.5 group" aria-label={`${SITE.name} home`}>
          ...
          <span className="flex flex-col leading-none">
            <span className="font-heading font-extrabold text-espresso text-[0.95rem] tracking-tight">Trucking WC</span>
            <span className="font-heading font-semibold text-clay text-[0.6rem] uppercase tracking-[0.18em]">Workers Compensation</span>
          </span>
        </Link>
